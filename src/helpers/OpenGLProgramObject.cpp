...
namespace GLHelpers {
	...
	// static method
	size_t ProgramObject::GetNumberOfBinaryFormats()
	{
		GLint iTemp;
	...
	// static method
	std::vector< GLint > ProgramObject::GetBinaryFormats()
	{
	...
	ProgramObject::ProgramObject( GLenum eBinaryFormat, const char* pData, size_t sSize )
	{
	...
	std::string ProgramObject::GetLinkError() const
	{
	...
	std::string ProgramObject::GetError() const
	{
	...
	std::string ProgramObject::GetInfoLog() const
	{
		GLint iLogLength;
	...
	GLint ProgramObject::GetUniformLocation( const char* szUniformName ) const
	{
		return glGetUniformLocation( programId, szUniformName );
	}

	GLint ProgramObject::GetUniformLocation( const std::string strUniformName ) const
	{
		return glGetUniformLocation( programId, strUniformName.c_str() );
	}

	GLint ProgramObject::GetUniformBufferSize( const char* szBufferName ) const
	{
		return glGetUniformBufferSizeEXT ? glGetUniformBufferSizeEXT( programId, GetUniformLocation( szBufferName ) ) : 0;
	}

	void ProgramObject::Use(bool enable) const
	{
	...
	void ProgramObject::AttachShader( const ShaderObject& shaderObject ) const
	{
	...
	size_t ProgramObject::GetNumberOfAttachedShaders() const
	{
		GLint iAttached;
	...
	void ProgramObject::SetAttributeLocation(const char* attributeName, GLuint index) const
	{
		glBindAttribLocation( programId, index, attributeName);
	}

	GLint ProgramObject::GetAttribLocation( const char* szAttribLocationName ) const
	{	
		return glGetAttribLocation( programId, szAttribLocationName );
	}

	size_t ProgramObject::GetNumberOfActiveAttributes() const
	{
		GLint iAttached;
	...
	size_t ProgramObject::GetLengthLongestAttributeName() const
	{
		GLint iAttached;
	...
	void ProgramObject::GetAttribute( GLuint uiAttribIndex, std::string& strAttributeName, GLint& iSize, GLenum& eType ) const
	{
	...
	void ProgramObject::GetAttribute( GLuint uiAttribIndex, std::string& strAttributeName, GLint& iSize, GLenum& eType, GLint& iLocation ) const
	{
	...
	void ProgramObject::GetAttribute( GLuint uiAttribIndex, std::string& strAttributeName, GLenum& eType ) const
	{
		GLint iSize;
		GLenum eOGLType;
	...
	void ProgramObject::GetAttribute( GLuint uiAttribIndex, std::string& strAttributeName, GLenum& eType, GLint& iLocation ) const
	{
	...
	size_t ProgramObject::GetNumberOfActiveUniforms() const
	{
		GLint iAttached;
	...
	GLsizei ProgramObject::GetLengthLongestUniformName() const
	{
		GLsizei iAttached;
	...
	void ProgramObject::GetUniform( GLuint uiUniformIndex, std::string& strUniformName, GLint& iSize, GLenum& eType ) const
	{
	...
	void ProgramObject::GetUniform( GLuint uiUniformIndex, std::string& strUniformName, GLint& iSize, GLenum& eType, GLint& iLocation ) const
	{
	...
	GLuint ProgramObject::GetUniformBlockIndex( const char* szUniformBlockName ) const
	{
		return glGetUniformBlockIndex( programId, szUniformBlockName );
	}

	void ProgramObject::SetUniformBlockBinding(GLuint uniformBlockIndex, GLuint uniformBlockBinding) const
	{
		glUniformBlockBinding(programId, uniformBlockIndex, uniformBlockBinding);
	}

	void ProgramObject::SetUniformBlockBinding(const char* szUniformBlockName, GLuint uniformBlockBinding) const
	{
	...
	std::string ProgramObject::GetActiveUniformName( GLuint uiUniformIndex ) const
	{
	...
	size_t ProgramObject::GetNumberOfActiveUniformBlocks() const
	{
		GLint iAttached;
	...
	size_t ProgramObject::GetLengthLongestUniformBlock() const
	{
		GLint iAttached;
	...
	size_t ProgramObject::GetUniformBlockDataSize( GLuint uiUniformBlockIndex ) const
	{
		Assert( !"Untested!" );
	...
	size_t ProgramObject::GetUniformBlockActiveUniforms( GLuint uiUniformBlockIndex ) const
	{
		Assert( !"Untested!" );
	...
	size_t ProgramObject::GetUniformBlockNameLength( GLuint uiUniformBlockIndex ) const
	{
	...
	void   
	ProgramObject::SetUniformBlock(const char* szUniformBlockName, const BufferObject& buffer, GLuint uniformBlockBinding, GLintptr offset, GLsizeiptr size) const
	{
		SetUniformBlockBinding(szUniformBlockName, uniformBlockBinding);

		if (size == 0) size = buffer.m_sizeInBytes;
		glBindBufferRange(GL_UNIFORM_BUFFER, uniformBlockBinding, buffer.m_uiBufferIdx , 0, size);

		check_opengl();
	}

	GLuint 
	ProgramObject::GetSSBOResourceIndex(const char* szUniformBlockName) const
	{
	...
	void 
	ProgramObject::SetSSBO(const char* szUniformBlockName, const BufferObject& buffer, GLuint bindingPointIndex, GLintptr offset, GLsizeiptr size) const
	{
		...
		glBindBufferBase(GL_SHADER_STORAGE_BUFFER, bindingPointIndex, buffer.m_uiBufferIdx);

		check_opengl();

	}

	std::string ProgramObject::GetUniformBlockName( GLuint uiUniformBlockIndex ) const
	{
		Assert( !"Todo" );
		return std::string( "blub" );
	}

	void ProgramObject::SetGeometryShaderNumVerticesOut( int32_t iNumVerticesOut ) const
	{
	...
	void ProgramObject::SetGeometryShaderInputType( GLenum eType ) const
	{
	...
	void ProgramObject::SetGeometryShaderOutputType( GLenum eType ) const
	{
		Assert( ( ( eType == GL_POINTS ) ||
					( eType == GL_LINE_STRIP ) ||
	...
	GLint ProgramObject::GetTessellationControlOutputVertices() const
	{
		Assert( !"Untested" );
		GLint iReturn = 0;
	...
	GLint ProgramObject::GetTessellationGenerationMode() const
	{
		Assert( !"Untested" );
		GLint iReturn = 0;
		// signature: (GLuint program, GLenum pname, GLint* param);
	...
	GLint ProgramObject::GetTessellationGenerationSpacing() const
	{
		Assert( !"Untested" );
		GLint iReturn = 0;
		// signature: (GLuint program, GLenum pname, GLint* param);
	...
	GLint ProgramObject::GetTessellationGenerationVertexOrder() const
	{
		Assert( !"Untested" );
		GLint iReturn = 0;
		// signature: (GLuint program, GLenum pname, GLint* param);
	...
	GLint ProgramObject::GetTessellationGenerationPointMode() const
	{
		Assert( !"Untested" );
		GLint iReturn = 0;
		// signature: (GLuint program, GLenum pname, GLint* param);
	...
	void ProgramObject::SetBinaryHint( bool bHint ) const
	{
	...
	std::unique_ptr< char[] > ProgramObject::GetBinary( GLenum& refBinaryFormat, size_t& refSize ) const
	{
		...
		if ( iProgramLength == 0 ) {
			SetBinaryHint( true );
			ProgramObject* pProgramNonConst = const_cast< ProgramObject* >( this );
	...
	void ProgramObject::UploadBinary( GLenum eBinaryFormat, const char* szData, size_t sSize )
	{
...
#define check_type(type) (void)(0)
	...
	void ProgramObject::SetUniform(const std::string& uniformName, GLboolean value)
	{
		SetUniform(uniformName, GLint(value));
	}

	void ProgramObject::SetUniform(const std::string& uniformName, GLint value) {
	...
	void ProgramObject::SetUniform(const std::string& uniformName, const std::vector<GLint>& values, GLint count) {
		check_is_member(uniformName);
		check_type(GL_FLOAT);
	...
	void ProgramObject::SetUniform(const std::string& uniformName, GLuint value) {
		check_is_member(uniformName);
	...
	void ProgramObject::SetUniform(const std::string& uniformName, const std::vector<GLuint>& values, GLint count) {
		check_is_member(uniformName);
		check_type(GL_FLOAT);
		GLsizei uniform_count = count >= 0 ? (GLsizei) count : (GLsizei) values.size();
	...
	void ProgramObject::SetUniform(const std::string& uniformName, GLfloat value) {
		check_is_member(uniformName);
		check_type(GL_FLOAT);
		glProgramUniform1f(programId, GetUniformLocation(uniformName), value);
	}

	void ProgramObject::SetUniform(const std::string& uniformName, const std::vector<GLfloat>& values, GLint count) {
		check_is_member(uniformName);
		check_type(GL_FLOAT);
		GLsizei uniform_count = count >= 0 ? (GLsizei) count : (GLsizei) values.size();
	...
	void ProgramObject::SetUniform(const std::string& uniformName, const glm::ivec2& value) {
		check_is_member(uniformName);
		check_type(GL_INT_VEC2);
		glProgramUniform2iv(programId, GetUniformLocation(uniformName), 1, glm::value_ptr(value));
	}

	void ProgramObject::SetUniform(const std::string& uniformName, const glm::vec2& value) {
		check_is_member(uniformName);
		check_type(GL_FLOAT_VEC2);
		glProgramUniform2fv(programId, GetUniformLocation(uniformName), 1, glm::value_ptr(value));
	}

	void ProgramObject::SetUniform(const std::string& uniformName, const std::vector<glm::vec2>& values, GLint count) {
		check_is_member(uniformName);
		check_type(GL_FLOAT_VEC2);
		GLsizei uniform_count = count >= 0 ? (GLsizei) count : (GLsizei) values.size();
	...
	void ProgramObject::SetUniform(const std::string& uniformName, const glm::ivec3& value) {
		check_is_member(uniformName);
		check_type(GL_INT_VEC3);
		glProgramUniform3iv(programId, GetUniformLocation(uniformName), 1, glm::value_ptr(value) );
	}

	void ProgramObject::SetUniform(const std::string& uniformName, const glm::vec3& value) {
		check_is_member(uniformName);
		check_type(GL_FLOAT_VEC3);
		glProgramUniform3fv(programId, GetUniformLocation(uniformName), 1, glm::value_ptr(value));
	}

	void ProgramObject::SetUniform(const std::string& uniformName, const std::vector<glm::vec3>& values, GLint count) {
		check_is_member(uniformName);
		check_type(GL_FLOAT_VEC3);
		GLsizei uniform_count = count >= 0 ? (GLsizei) count : (GLsizei) values.size();
	...
	void ProgramObject::SetUniform(const std::string& uniformName, const glm::ivec4& value) {
		check_is_member(uniformName);
		check_type(GL_INT_VEC4);
		glProgramUniform4iv(programId, GetUniformLocation(uniformName), 1, glm::value_ptr(value));
	}

	void ProgramObject::SetUniform(const std::string& uniformName, const glm::vec4& value) {
		check_is_member(uniformName);
		check_type(GL_FLOAT_VEC4);
		glProgramUniform4fv(programId, GetUniformLocation(uniformName), 1, glm::value_ptr(value));
	}

	void ProgramObject::SetUniform(const std::string& uniformName, const glm::quat& value) {
		check_is_member(uniformName);
		check_type(GL_FLOAT_VEC4);
		glProgramUniform4fv(programId, GetUniformLocation(uniformName), 1, glm::value_ptr(value));
	}

	void ProgramObject::SetUniform(const std::string& uniformName, const std::vector<glm::vec4>& values, GLint count) {
		check_is_member(uniformName);
		check_type(GL_FLOAT_VEC4);
		GLsizei uniform_count = count >= 0 ? (GLsizei) count : (GLsizei) values.size();
	...
	void ProgramObject::SetUniform(const std::string& uniformName, const std::vector<glm::quat>& values, GLint count) {
		check_is_member(uniformName);
		check_type(GL_FLOAT_VEC4);
		GLsizei uniform_count = count >= 0 ? (GLsizei) count : (GLsizei) values.size();
		glProgramUniform4fv(programId, GetUniformLocation(uniformName), uniform_count, (float *)values.data());
	...
	void ProgramObject::SetUniform(const std::string& uniformName, const glm::mat3x3& value, GLboolean transpose) {
		check_is_member(uniformName);
	...
	void ProgramObject::SetUniform(const std::string& uniformName, const std::vector<glm::mat3x3>& values, GLboolean transpose, GLint count) {
		check_is_member(uniformName);
		check_type(GL_FLOAT_MAT3);
	...
	void ProgramObject::SetUniform(const std::string& uniformName, const glm::mat4x4& value, GLboolean transpose) {
		check_is_member(uniformName);
	...
	void ProgramObject::SetUniform(const std::string& uniformName, const std::vector<glm::mat4x4>& values, GLboolean transpose, GLint count) {
		check_is_member(uniformName);
		check_type(GL_FLOAT_MAT4);
		GLsizei matrix_count = count >= 0 ? (GLsizei) count : (GLsizei) values.size();
	...
	void ProgramObject::GetUniform(const std::string& uniformName, GLint *value) {
		check_is_member(uniformName);
	...
	void ProgramObject::GetUniform(const std::string& uniformName, GLuint *value) {
		check_is_member(uniformName);
		check_type(GL_UNSIGNED_INT);
		glGetUniformuiv(programId, GetUniformLocation(uniformName), value);
	}

	void ProgramObject::GetUniform(const std::string& uniformName, GLfloat *value) {
		check_is_member(uniformName);
		check_type(GL_FLOAT);
		glGetUniformfv(programId, GetUniformLocation(uniformName), value);
	}

	void ProgramObject::GetUniform(const std::string& uniformName, glm::vec2 *value) {
		check_is_member(uniformName);
		check_type(GL_FLOAT_VEC2);
		glGetUniformfv(programId, GetUniformLocation(uniformName), glm::value_ptr(*value));
	}

	void ProgramObject::GetUniform(const std::string& uniformName, glm::vec3 *value) {
		check_is_member(uniformName);
		check_type(GL_FLOAT_VEC3);
		glGetUniformfv(programId, GetUniformLocation(uniformName), glm::value_ptr(*value));
	}

	void ProgramObject::GetUniform(const std::string& uniformName, glm::vec4 *value) {
		check_is_member(uniformName);
		check_type(GL_FLOAT_VEC4);
		glGetUniformfv(programId, GetUniformLocation(uniformName), glm::value_ptr(*value));
	}

	void ProgramObject::GetUniform(const std::string& uniformName, glm::mat3x3 *value) {
		check_is_member(uniformName);
		check_type(GL_FLOAT_MAT3);
		glGetUniformfv(programId, GetUniformLocation(uniformName), glm::value_ptr(*value));
	}

	void ProgramObject::GetUniform(const std::string& uniformName, glm::mat4x4 *value) {
		check_is_member(uniformName);
		check_type(GL_FLOAT_MAT4);
		glGetUniformfv(programId, GetUniformLocation(uniformName), glm::value_ptr(*value));
	}
	...
	template <class T>
	static void SetTextureT(ProgramObject* program, const T& texture, const std::string& uniformSamplerName, GLuint textureUnit, GLint sampler)
	{
	...
	void ProgramObject::SetTexture(const std::string& uniformSamplerName, const TextureObject1D& texture, GLuint textureUnit, const SamplerObject& sampler) {
		SetTextureT<TextureObject1D>(this, texture, uniformSamplerName, textureUnit, sampler.id);
	}

	void ProgramObject::SetTexture(const std::string& uniformSamplerName, const TextureObject2D& texture, GLuint textureUnit, const SamplerObject& sampler) {
		SetTextureT<TextureObject2D>(this, texture, uniformSamplerName, textureUnit, sampler.id);
	}

	void ProgramObject::SetTexture(const std::string& uniformSamplerName, const TextureObject3D& texture, GLuint textureUnit, const SamplerObject& sampler) {
		SetTextureT<TextureObject3D>(this, texture, uniformSamplerName, textureUnit, sampler.id);
	}

	void ProgramObject::SetTexture(const std::string& uniformSamplerName, const TextureObjectCube& texture, GLuint textureUnit, const SamplerObject& sampler) {
		SetTextureT<TextureObjectCube>(this, texture, uniformSamplerName, textureUnit, sampler.id);
	}

	void ProgramObject::SetTexture(const std::string& uniformSamplerName, const TextureObjectBuffer& texture, GLuint textureUnit, const SamplerObject& sampler) {
		SetTextureT<TextureObjectBuffer>(this, texture, uniformSamplerName, textureUnit, sampler.id);
	}

	void ProgramObject::SetTexture(const std::string& uniformSamplerName, const TextureObject2DArray& texture, GLuint textureUnit, const SamplerObject& sampler) {
		SetTextureT<TextureObject2DArray>(this, texture, uniformSamplerName, textureUnit, sampler.id);
	}

	void ProgramObject::SetTexture(const std::string& uniformSamplerName, const TextureObjectCubeArray& texture, GLuint textureUnit, const SamplerObject& sampler) {
		SetTextureT<TextureObjectCubeArray>(this, texture, uniformSamplerName, textureUnit, sampler.id);
	}

	void ProgramObject::SetImageTexture(const TextureObject& texture, GLuint textureUnit, GLenum access, GLint level, GLboolean layered, GLint layer)
	{
		...
		glBindImageTexture(textureUnit, texture.m_uiOpenGLID, level, layered, layer, access, texture.internalFormat);
		check_opengl();
	}

	//void ProgramObject::setTexture(std::string uniformSamplerName, const TextureObject& texture, GLenum textureTarget) {
	//	check_is_member(uniformSamplerName);
	...
	//void ProgramObject::setImageTexture(std::string uniformImageName, Texture *texture, GLint level, GLboolean layered, GLint layer, GLenum access) {
	//	check_is_member(uniformImageName);
	...
	void ProgramObject::CompileProgram(const ShaderPaths& paths, LogToFile* log, const Detail::ShaderCommandLine& cmd)
	{
	...
	void ProgramObject::CompileProgram(const ShaderPaths& paths, LogToFile* log)
	{
		CompileProgram(paths, log, Detail::ShaderCommandLine());
	}


	void ProgramObject::CompileComputeProgram(LogToFile* log, String computeShaderFilename, const Detail::ShaderCommandLine& cmd)
	{
		{ /// Initialize render program
	...
	void ProgramObject::CompileComputeProgram(LogToFile* log, String computeShaderFilename)
	{
		CompileComputeProgram(log, computeShaderFilename, Detail::ShaderCommandLine());
	}

	void ProgramObject::DispatchCompute(const int& gridSize, const int& groupSize, bool useVariableGroupSizeIfAvailable)
	{
		DispatchCompute(glm::ivec3(gridSize, 1, 1), glm::ivec3(groupSize, 1, 1), useVariableGroupSizeIfAvailable);
	}

	void ProgramObject::DispatchCompute(const glm::ivec2& gridSize, const glm::ivec2& groupSize, bool useVariableGroupSizeIfAvailable)
	{
		DispatchCompute(glm::ivec3(gridSize.x, gridSize.y, 1), glm::ivec3(groupSize.x, groupSize.y, 1), useVariableGroupSizeIfAvailable);
	}

	void ProgramObject::DispatchCompute(const glm::ivec3& gridSize, const glm::ivec3& groupSize, bool useVariableGroupSizeIfAvailable)
	{
		Use();
